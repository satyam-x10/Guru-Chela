        ...
        loading ? (
          ...
          <>
            ...
            <Routes>
              ...
              <Route path="/admin/createcourses" element={<ProtectedRoute isAuthenticated={isAuthenticated} adminRoute={true} isAdmin={user && user.role === "admin"}redirect="."><CreateCourses admin={admin} /></ProtectedRoute>} />
